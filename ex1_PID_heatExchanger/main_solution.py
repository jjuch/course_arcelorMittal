...
stap_grootte = 10
K = np.mean(data[-10:])/stap_grootte
Ts = t[1] - t[0] # bemonsteringtijd
a, b, q = raaklijn(data, Ts=Ts, plot_verbose=True) 
t_0 = a - b / q # raaklijn kruist y = 0
t_K = (K * stap_grootte + q * a - b)/q # raaklijn kruist y = K
tau = (t_K - t_0)
# Dode tijd:
