...
def LQR(model, x=True, y=False, plot=False):
    ...
    -------
        Ki : the LQR gains.
        tf_i : state space model from LQR.

    '''
    ######################################################
    ####    Calculate the LQR gain for model in x ########
    ######################################################
    tf = None
    Ki, _, _ = None, None, None


    ######################################################
    ####    Create closed-loop with LQR           ########
    ######################################################
    cli = None
...
def LQG(model, plot=False):
    ...
    # Closed-loop state space model
    ######################################################
    ##   Find the state space model for LQG yourself #####
    ######################################################
